...
| Метрика | Описание | Почему важна для guardrail |
|---|---|---|
| **Recall@FPR=0.05** | TPR при 5% ложных блокировок | Основная рабочая точка |
| **Recall@FPR=0.10** | TPR при 10% ложных блокировок | Мягкая рабочая точка |
...
| Модель | Режим | Recall@FPR=0.05 | Recall@FPR=0.10 | AUROC | F1 (OOS) | Latency (ms) |
|---|---|---|---|---|---|---|
...
- [DA-ADB paper](https://arxiv.org/abs/2105.03770)
