...
Использование:
    ...
    # Full train
    python scripts/run_autointent.py --mode full
...
def get_model_dir(pilot: bool, mode: str, n_shots: int | None, seed: int | None) -> Path:
    ...
    return task_dir / "runs" / f"{model_name}_{mode_str}_seed{seed_val}"
